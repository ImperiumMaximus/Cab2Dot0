...
\begin{enumerate}
	\item \codeline{516} and \codeline{517}. Consider using a local variable as returned value by  \texttt{DOLUtils.getDefaultLogger()} method, instead of chaining function calls.

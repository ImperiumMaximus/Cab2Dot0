...
\begin{enumerate}
	...
	\item \codeline{401}. Consider using a local variable with value returned by \break\texttt{element.getQName()}, instead of chaining function calls.
	\sourcesnippet{401-401}{\texttt{element.getQName().equals(\dots)} methods chaining}{Code/DeploymentDescriptorNode.java}
	\item \codeline{399}. Consider declaring a variable using type \texttt{Enumeration<String>} in order to avoid casts in \codeline{400}. This improves readability.
...
\begin{enumerate}
	...
	\item \codeline{450}, \codeline{451}, \codeline{460}, \codeline{466}, \codeline{472}, \codeline{475}, \codeline{477}, \codeline{480}, \codeline{482} and \codeline{487}. Consider using a local variable with value returned by \texttt{DOLUtils.getDefaultLogger()}, instead of chaining function calls.
	...
	\item \codeline{444}. Consider declaring a variable using type \texttt{Map<String, String>}  in order to avoid casts in \codeline{458}. This improves readability.
...
\begin{enumerate}
	\item \codeline{516} and \codeline{517}. Consider using a local variable with value returned by \break \texttt{DOLUtils.getDefaultLogger()}, instead of chaining function calls.
...
\item \codeline{657}. Consider using a local variable with value returned by \texttt{DOLUtils.getDefaultLogger()} method, instead of chaining function calls.
...
\begin{enumerate}
\item \codeline{806}. Consider using type \texttt{<EjbReference>}  when a \texttt{Set} and a \texttt{HashSet} are declared to avoid errors caused by insertion of different type elements.

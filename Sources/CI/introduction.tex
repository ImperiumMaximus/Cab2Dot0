...
\subsection{Scope}
As said before the Code Inspection is applied to an existing software project which is being developed, in this case the it is called Glassfish which is an open source implementation of a JEE server.
